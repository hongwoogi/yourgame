...
상태: GitHub·Vercel 연결과 준비 페이지 자동 배포는 완료했다. 첫 제안 모집은 즉시 개시하고 2026-08-31 23:00 한국시간에 마감하며, 첫 게임 공개 목표는 2026-09-01 00:00 한국시간으로 확정했다. 로컬 게임 변경 작업자와 공개 집계의 실제 구현·검증 상태는 별도로 기록한다. 실제 연결 현황은 [인프라 연결 상태](infrastructure-status.md)를 따른다.
